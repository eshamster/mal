...
IMPLS = bash c clojure coffee cpp crystal cs erlang es6 factor forth fsharp esh-fsharp go groovy \
...
esh-fsharp_STEP_TO_PROG =  esh-fsharp/$($(1)).exe
...
esh-fsharp_RUNSTEP =  mono ../$(2) --raw $(3)
go_RUNSTEP =      ../$(2) $(3)
